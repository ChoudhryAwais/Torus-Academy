...
<body>
	<?php
		...
		if ($majorsub=="Entry_Test")
		{
			// echo "Entry test Subject";echo "<br>";
			$sub = $_POST['sub'];
			$month = "";
			// echo $sub;  
		}
		else if ($majorsub=="Courses")
		{
			// echo "Course";echo "<br>";
			$sub = $_POST['sub'];
			if (($class=="Computer")&&(($sub=="Basic_Comp_Course")||($sub=="Short_Hand_Writing")))
			{
				$month = '2';
			}
			else if (($class=="Computer")&&($sub=="Adv_Comp_Course")) 
			{
				$month = '3';	
			}
			else
		...
		$reg = 1500;
		$other = 0;		
		if (($sub=="English_lang")&&($month=="3")) 
		{
			$tuition =12000;
		}
		else if (($sub=="English_lang")&&($month=="2")) 
		{
			$tuition =8000;
		}
		else if (($class=="Computer")&&($month=="2")) 
		{
			$tuition =10000;
		}
		else if (($class=="Computer")&&($month=="3")) 
		{
			$tuition =15000;
		}
		else if ($sub=="ILETS") 
