...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="pics/t5.png">
	<script type="text/javascript" src="javascript/uplogin.js?v=<?php echo time(); ?>" ></script>
...
<body style="background-image: url('pics/t4.png');background-repeat: no-repeat; background-size:700px 100vh;background-position:top;">
	...
	<form class="row form1 form-group" action="AdminQue/adminpage.php" method="post" onsubmit="return logincheck()">
		<input type="hidden" id="ausername" value="<?php echo $username?>">
		<input type="hidden" id="apassword" value="<?php echo $password?>">
		<div class="col-lg-4"></div>
		<div class="col-lg-4 bg-white border" style="border-radius: 0px;">
			<div class="row p-4 text-white font-weight-bold text-uppercase h4 border" style="background-color: #DEDEDE">
				<div class="col-lg-12">
		...
		<div class="col-lg-4"></div>
		<input type="hidden" name="adminlogincheck1" value="true">
	</form>
</body>
</html>